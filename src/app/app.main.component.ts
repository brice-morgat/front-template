...
import { ConfigService } from './_shared/primeng/service/app.config.service';
import { AppConfig } from './_shared/primeng/api/appconfig';
...
export class AppMainComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    ngAfterViewInit() {
        // hides the overlay navbar and top navbar if outside is clicked
