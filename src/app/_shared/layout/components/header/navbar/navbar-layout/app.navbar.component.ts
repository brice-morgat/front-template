    ...
    template: `
        <div class="layout-menu-container">
            <ul class="layout-menu" role="menu" (keydown)="onKeydown($event)">
                <li app-navbar class="layout-menuitem-category" *ngFor="let item of model; let i = index;" [item]="item"
                    [index]="i" [root]="true" role="none">
                    <div class="layout-menuitem-root-text" [attr.aria-label]="item.label">{{item.label}}</div>
                    <ul role="menu">
                        <li app-navbar-item *ngFor="let child of item.items" [item]="child" [index]="i" role="none"></li>
                    </ul>
                </li>
                <a href="https://www.primefaces.org/primeblocks-ng/#/">
                    ...
                    <img src="assets/images/icon.png" alt="Prime Blocks"
                         class="w-full mt-3"/>
                </a>
            </ul>
        </div>
        ...
        this.model = [
            {
                ...
                items: [
                    ...
                    {label: 'Patient', icon: 'pi pi-fw pi-home', routerLink: ['/patient']},
                ]
            },
            // {
            //     label: 'UI Components',
            ...
            //         {label: 'Menu', icon: 'pi pi-fw pi-bars', routerLink: ['/uikit/navbar'], preventExact: true},
