        ...
        <ng-container>
            ...
            <ul *ngIf="(item.items && active) && item.visible !== false"
                ...
                <ng-template ngFor let-child let-i="index" [ngForOf]="item.items">
                    <li app-navbar-item [item]="child" [index]="i" [parentKey]="key" [class]="child.badgeClass"
                        role="none"></li>
                </ng-template>
            </ul>
        </ng-container>
...
export class AppNavbarItemsComponent implements OnInit, OnDestroy {
    ...
    constructor(public app: AppMainComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService) {
        this.menuSourceSubscription = this.menuService.menuSource$.subscribe(key => {
            // deactivate current active navbar
